...
let controls, hand1, hand2, controller1, controller2, controllerGrip1, controllerGrip2, rayCaster, group, controllerModelFactory, handModelFactory, handModel1, handModel2
const intersected = [];
const handModels =
{
	left: null,
